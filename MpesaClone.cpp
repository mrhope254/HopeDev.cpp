...
int main() {
   ...
   case 3:{//case3 option
       ...
       if(aOption == 1){
        ...
        // CONFIRMATION 
         cout << "\Buy " << amount << "/= Airtime from " << "Your Mpesa. Transaction cost Kshs: " << transaction << ".00 " << "To Continue reply with 1 to STOP reply with 2." << endl;
         cout << "1." << "Yes" << endl;
         cout << "2." << "No" << endl;
         cin >> confirm;
      ...
      //Buy for other phone
        ...
        // CONFIRMATION 
         cout << "\Buy " << amount << "/= Airtime for " <<phone << " Using Mpesa, Transaction cost Kshs: " << transaction << ".00 " << "To Continue reply with 1 to STOP reply with 2." << endl;
         cout << "1." << "Yes" << endl;
         cout << "2." << "No" << endl;
         cin >> confirm;
